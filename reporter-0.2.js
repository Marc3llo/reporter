function reporter(idList){
  ...
  //$('head').append('<link rel="stylesheet" href="http://feedback.site/reporter-0.1-min.css">');
  $('head').append('<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/Marc3llo/reporter@master/reporter-0.1-min.css">');
